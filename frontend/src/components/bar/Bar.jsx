    ...
    return (
        <div className="bar-card flex justify-around items-center shadow-md rounded-lg m-2">
            <div className="bar-card-image-container rounded-l-lg w-1/3">
                <img src={bar.image} alt={bar.name} className="bar-card-image w-full" />
            </div>
            <div className="container-infos flex flex-col justify-center items-center rounded-r-lg backdrop-blur-sm text-light">
