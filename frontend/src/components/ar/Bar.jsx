...
const Bar = ({ bar }) => {
    ...
    return (
        <article onClick={handleBarClick} aria-label={`Navigation vers la page de la bière ${bar.name}`} className="bar-card flex flex-col md:flex-row lg:flex-row justify-between items-center shadow-md rounded-lg w-[95%] bg-dark-black border-1 border-primary light-mode:bg-light flex-shrink-0 cursor-pointer">
            <div className="bar-card-image-container rounded-t-md w-full md:rounded-l-lg md:rounded-tr-none lg:rounded-tr-none lg:rounded-l-lg md:w-[40%] lg:w-1/3 h-54">
